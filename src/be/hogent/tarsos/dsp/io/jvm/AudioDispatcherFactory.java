...
package be.hogent.tarsos.dsp.io.jvm;
...
import be.hogent.tarsos.dsp.io.PipedAudioStream;
...
public class AudioDispatcherFactory {
	 ...
	 */
	public static AudioDispatcher fromDefaultMicrophone(final int audioBufferSize, final int bufferOverlap) throws LineUnavailableException, UnsupportedAudioFileException {
	 ...
	 * @throws LineUnavailableException
	 */
	public static AudioDispatcher fromDefaultMicrophone(final int sampleRate,final int audioBufferSize, final int bufferOverlap) throws LineUnavailableException, UnsupportedAudioFileException {
	 ...
	 */
	public static AudioDispatcher fromPipe(final String source,final int targetSampleRate, final int audioBufferSize,final int bufferOverlap) throws UnsupportedAudioFileException {
		if(new File(source).exists()&&new File(source).isFile() && new File(source).canRead()){
			...
			return new AudioDispatcher((AudioInputStream) audioStream, audioBufferSize, bufferOverlap);
		}else{
